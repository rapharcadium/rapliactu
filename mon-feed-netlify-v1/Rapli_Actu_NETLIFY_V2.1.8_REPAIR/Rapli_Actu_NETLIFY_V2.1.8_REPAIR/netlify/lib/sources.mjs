...
export const SOURCES = [
  ...
  { id:'lemarin', name:'Le Marin', domain:'lemarin.ouest-france.fr', category:'transport', icon:'⚓', color:'#4cb7c5', collectDepth:20, adapter:'lemarin', revision:'lemarin-v2', page:'https://lemarin.ouest-france.fr/', readerFallback:false, replaceCurrentOnSuccess:true, rejectInferredStored:true, availabilityDefault:'mixed' },
...
export function isStoredArticleAllowed(item) {
  ...
  if (source.revision && item?.sourceRevision !== source.revision) return false;
  return true;
}
