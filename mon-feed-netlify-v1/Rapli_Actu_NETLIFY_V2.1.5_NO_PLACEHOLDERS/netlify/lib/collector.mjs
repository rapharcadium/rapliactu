...
export async function collectAll(){
  ...
  const feed={version:'2.1.5',generatedAt:nowIso(),cycleStartedAt,currentPerSource:CURRENT_PER_SOURCE,historyDays:HISTORY_DAYS,stats:{sources:sources.length,ok,stale,errors,disabled,articles:articles.length,newThisCycle:discovered.length},sources,articles};
