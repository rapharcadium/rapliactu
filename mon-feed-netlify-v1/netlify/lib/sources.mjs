...
export const SOURCES = [
  ...
  { id:'lemarin', name:'Le Marin', domain:'lemarin.ouest-france.fr', category:'transport', icon:'⚓', color:'#4cb7c5', collectDepth:60, adapter:'genericHtml', page:'https://lemarin.ouest-france.fr/', readerFallback:true, linkPattern:/^https?:\/\/lemarin\.ouest-france\.fr\/(?!connexion|abonnement|mentions|contact|recherche|$)/i, availabilityDefault:'mixed' },
